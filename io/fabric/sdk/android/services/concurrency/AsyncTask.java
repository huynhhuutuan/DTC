...
public abstract class AsyncTask<Params, Progress, Result> {
    ...
    private static final ThreadFactory threadFactory = new C07471();
    ...
    private final WorkerRunnable<Params, Result> worker = new C11632();

    static class C07471 implements ThreadFactory {
    ...
    class C11632 extends WorkerRunnable<Params, Result> {
        C11632() {
            super();
        }
