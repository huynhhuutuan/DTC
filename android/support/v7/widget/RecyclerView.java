...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild {
    ...
    private static final Interpolator sQuinticInterpolator = new C01903();
    ...
    static class C01903 implements Interpolator {
        C01903() {
        }
    ...
    class C08474 implements ProcessCallback {
        C08474() {
        }
    ...
    class C08485 implements Callback {
        C08485() {
        }
    ...
    class C08496 implements Callback {
        C08496() {
        }
    ...
    public RecyclerView(Context context, @Nullable AttributeSet attrs, int defStyle) {
        ...
        this.mUpdateChildViewsRunnable = new C01881();
        ...
        this.mItemAnimatorRunner = new C01892();
        this.mViewInfoProcessCallback = new C08474();
        ...
        if (attrs != null) {
            TypedArray a = context.obtainStyledAttributes(attrs, C0164R.styleable.RecyclerView, defStyle, 0);
    ...
    private void initChildrenHelper() {
        this.mChildHelper = new ChildHelper(new C08485());
    }

    void initAdapterManager() {
        this.mAdapterHelper = new AdapterHelper(new C08496());
    }
