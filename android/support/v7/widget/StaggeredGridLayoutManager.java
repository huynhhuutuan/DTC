...
public class StaggeredGridLayoutManager extends LayoutManager {
    ...
    private final Runnable mCheckForGapsRunnable = new C02031();
    ...
    static class LazySpanLookup {
        ...
        static class FullSpanItem implements Parcelable {
            public static final Creator<FullSpanItem> CREATOR = new C02041();
            int mGapDir;
            int[] mGapPerSpan;
            boolean mHasUnwantedGapAfter;
            int mPosition;

            static class C02041 implements Creator<FullSpanItem> {
                C02041() {
                }
