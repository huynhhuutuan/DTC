...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, NestedScrollingParent {
    static final int[] ATTRS = new int[]{C0162R.attr.actionBarSize, 16842841};
    ...
    class C11771 extends ViewPropertyAnimatorListenerAdapter {
        C11771() {
        }
    ...
    public ActionBarOverlayLayout(Context context, AttributeSet attrs) {
        ...
        this.mTopAnimatorListener = new C11771();
        this.mRemoveActionBarHideOffset = new C01692();
        this.mAddActionBarHideOffset = new C01703();
        init(context);
    ...
    void pullChildren() {
        if (this.mContent == null) {
            this.mContent = (ContentFrameLayout) findViewById(C0162R.id.action_bar_activity_content);
            this.mActionBarTop = (ActionBarContainer) findViewById(C0162R.id.action_bar_container);
            this.mDecorToolbar = getDecorToolbar(findViewById(C0162R.id.action_bar));
        }
    }
