...
public class WindowDecorActionBar extends ActionBar implements ActionBarVisibilityCallback {
    ...
    final ViewPropertyAnimatorListener mHideListener = new C11741();
    ...
    final ViewPropertyAnimatorListener mShowListener = new C11752();
    private boolean mShowingForMode;
    private ScrollingTabContainerView mTabScrollView;
    private ArrayList<TabImpl> mTabs = new ArrayList();
    private Context mThemedContext;
    private TintManager mTintManager;
    final ViewPropertyAnimatorUpdateListener mUpdateListener = new C08313();

    class C08313 implements ViewPropertyAnimatorUpdateListener {
        C08313() {
        }
    ...
    class C11741 extends ViewPropertyAnimatorListenerAdapter {
        C11741() {
        }
    ...
    class C11752 extends ViewPropertyAnimatorListenerAdapter {
        C11752() {
        }
    ...
    private void init(View decor) {
        this.mOverlayLayout = (ActionBarOverlayLayout) decor.findViewById(C0162R.id.decor_content_parent);
        if (this.mOverlayLayout != null) {
            this.mOverlayLayout.setActionBarVisibilityCallback(this);
        }
        this.mDecorToolbar = getDecorToolbar(decor.findViewById(C0162R.id.action_bar));
        this.mContextView = (ActionBarContextView) decor.findViewById(C0162R.id.action_context_bar);
        this.mContainerView = (ActionBarContainer) decor.findViewById(C0162R.id.action_bar_container);
        ...
        TypedArray a = this.mContext.obtainStyledAttributes(null, C0162R.styleable.ActionBar, C0162R.attr.actionBarStyle, 0);
        if (a.getBoolean(C0162R.styleable.ActionBar_hideOnContentScroll, false)) {
            setHideOnContentScrollEnabled(true);
        }
        int elevation = a.getDimensionPixelSize(C0162R.styleable.ActionBar_elevation, 0);
        if (elevation != 0) {
    ...
    public Context getThemedContext() {
        if (this.mThemedContext == null) {
            ...
            this.mContext.getTheme().resolveAttribute(C0162R.attr.actionBarWidgetTheme, outValue, true);
