...
class ToolbarActionBar extends ActionBar {
    ...
    private final OnMenuItemClickListener mMenuClicker = new C08302();
    private final Runnable mMenuInvalidator = new C01601();
    ...
    class C08302 implements OnMenuItemClickListener {
        C08302() {
        }
...
*/
    ...
    private void ensureListMenuPresenter(Menu menu) {
        if (this.mListMenuPresenter == null && (menu instanceof MenuBuilder)) {
            ...
            this.mListMenuPresenter = new ListMenuPresenter(context2, C0162R.layout.abc_list_menu_item_layout);
