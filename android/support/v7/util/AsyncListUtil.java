...
public class AsyncListUtil<T> {
    ...
    private final BackgroundCallback<T> mBackgroundCallback = new C08332();
    final BackgroundCallback<T> mBackgroundProxy;
    final DataCallback<T> mDataCallback;
    int mDisplayedGeneration = 0;
    private int mItemCount = 0;
    private final MainThreadCallback<T> mMainThreadCallback = new C08321();
    ...
    class C08321 implements MainThreadCallback<T> {
        C08321() {
        }
    ...
    class C08332 implements BackgroundCallback<T> {
