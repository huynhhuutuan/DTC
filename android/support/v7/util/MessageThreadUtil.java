...
class MessageThreadUtil<T> implements ThreadUtil<T> {
    ...
    public MainThreadCallback<T> getMainThreadProxy(final MainThreadCallback<T> callback) {
        return new MainThreadCallback<T>() {
            ...
            private Runnable mMainThreadRunnable = new C01651();
            ...
            class C01651 implements Runnable {
                ...
                public void run() {
                    SyncQueueItem msg = C08341.this.mQueue.next();
                    while (msg != null) {
                        switch (msg.what) {
                            case 1:
    ...
    public BackgroundCallback<T> getBackgroundProxy(final BackgroundCallback<T> callback) {
        return new BackgroundCallback<T>() {
            ...
            private Runnable mBackgroundRunnable = new C01661();
            ...
            class C01661 implements Runnable {
                ...
                public void run() {
                    while (true) {
                        SyncQueueItem msg = C08352.this.mQueue.next();
                        if (msg != null) {
                            switch (msg.what) {
                                case 1:
                                    C08352.this.mQueue.removeMessages(1);
                                    callback.refresh(msg.arg1);
                                    break;
                                case 2:
                                    C08352.this.mQueue.removeMessages(2);
                                    C08352.this.mQueue.removeMessages(3);
                        ...
                        C08352.this.mBackgroundRunning.set(false);
                        return;
                    }
                }
            }
