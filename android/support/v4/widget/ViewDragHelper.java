...
public class ViewDragHelper {
    ...
    private static final Interpolator sInterpolator = new C01451();
    ...
    private final Runnable mSetIdleRunnable = new C01462();
    private int mTouchSlop;
    private int mTrackingEdges;
    private VelocityTracker mVelocityTracker;

    static class C01451 implements Interpolator {
        C01451() {
        }
