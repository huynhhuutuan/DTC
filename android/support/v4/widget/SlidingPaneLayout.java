...
public class SlidingPaneLayout extends ViewGroup {
    ...
    static class SavedState extends AbsSavedState {
        public static final Creator<SavedState> CREATOR = ParcelableCompat.newCreator(new C08241());
        boolean isOpen;

        static class C08241 implements ParcelableCompatCreatorCallbacks<SavedState> {
            C08241() {
            }
