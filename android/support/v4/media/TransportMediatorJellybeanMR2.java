...
class TransportMediatorJellybeanMR2 {
    OnAudioFocusChangeListener mAudioFocusChangeListener = new C00794();
    boolean mAudioFocused;
    final AudioManager mAudioManager;
    final Context mContext;
    boolean mFocused;
    final OnGetPlaybackPositionListener mGetPlaybackPositionListener = new C00805();
    final Intent mIntent;
    final BroadcastReceiver mMediaButtonReceiver = new C00783();
    PendingIntent mPendingIntent;
    int mPlayState = 0;
    final OnPlaybackPositionUpdateListener mPlaybackPositionUpdateListener = new C00816();
    final String mReceiverAction;
    final IntentFilter mReceiverFilter;
    RemoteControlClient mRemoteControl;
    final View mTargetView;
    final TransportMediatorCallback mTransportCallback;
    final OnWindowAttachListener mWindowAttachListener = new C00761();
    final OnWindowFocusChangeListener mWindowFocusListener = new C00772();

    class C00761 implements OnWindowAttachListener {
        C00761() {
        }
    ...
    class C00772 implements OnWindowFocusChangeListener {
        C00772() {
        }
    ...
    class C00794 implements OnAudioFocusChangeListener {
        C00794() {
        }
    ...
    class C00805 implements OnGetPlaybackPositionListener {
        C00805() {
        }
    ...
    class C00816 implements OnPlaybackPositionUpdateListener {
        C00816() {
        }
