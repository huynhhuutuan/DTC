...
abstract class ModernAsyncTask<Params, Progress, Result> {
    ...
    private static final ThreadFactory sThreadFactory = new C00461();
    ...
    private final WorkerRunnable<Params, Result> mWorker = new C07962();

    static class C00461 implements ThreadFactory {
    ...
    class C07962 extends WorkerRunnable<Params, Result> {
        C07962() {
            super();
        }
