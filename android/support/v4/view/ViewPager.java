...
public class ViewPager extends ViewGroup {
    ...
    class C08144 implements OnApplyWindowInsetsListener {
        private final Rect mTempRect = new Rect();
    ...
    public static class SavedState extends AbsSavedState {
        public static final Creator<SavedState> CREATOR = ParcelableCompat.newCreator(new C08151());
        Parcelable adapterState;
        ClassLoader loader;
        int position;

        static class C08151 implements ParcelableCompatCreatorCallbacks<SavedState> {
            C08151() {
            }
    ...
    void initViewPager() {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(this, new C08144());
    }
