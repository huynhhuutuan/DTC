...
public class TextInputLayout extends LinearLayout {
    ...
    class C07864 implements AnimatorUpdateListener {
        C07864() {
        }
    ...
    class C11682 extends ViewPropertyAnimatorListenerAdapter {
        C11682() {
        }
    ...
    class C11693 extends ViewPropertyAnimatorListenerAdapter {
        C11693() {
        }
    ...
    public void setError(@Nullable CharSequence error) {
        ...
        if (!TextUtils.isEmpty(error)) {
            ...
            ViewCompat.animate(this.mErrorView).alpha(1.0f).setDuration(200).setInterpolator(AnimationUtils.FAST_OUT_SLOW_IN_INTERPOLATOR).setListener(new C11682()).start();
            this.mErrorShown = true;
            updateEditTextBackground();
            updateLabelVisibility(true);
        } else if (this.mErrorView.getVisibility() == 0) {
            ViewCompat.animate(this.mErrorView).alpha(0.0f).setDuration(200).setInterpolator(AnimationUtils.FAST_OUT_SLOW_IN_INTERPOLATOR).setListener(new C11693()).start();
            this.mErrorShown = false;
            updateEditTextBackground();
        }
    }
    ...
    private void animateToExpansionFraction(float target) {
        if (this.mCollapsingTextHelper.getExpansionFraction() != target) {
            if (this.mAnimator == null) {
                ...
                this.mAnimator.setUpdateListener(new C07864());
            }
