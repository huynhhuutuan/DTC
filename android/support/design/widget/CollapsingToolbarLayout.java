...
public class CollapsingToolbarLayout extends FrameLayout {
    ...
    class C07691 implements OnApplyWindowInsetsListener {
        C07691() {
        }
    ...
    class C07702 implements AnimatorUpdateListener {
        C07702() {
        }
    ...
    public CollapsingToolbarLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(this, new C07691());
    }
    ...
    private void animateScrim(int targetAlpha) {
        ...
        if (this.mScrimAnimator == null) {
            ...
            this.mScrimAnimator.setUpdateListener(new C07702());
