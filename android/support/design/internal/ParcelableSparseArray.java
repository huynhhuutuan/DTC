...
public class ParcelableSparseArray extends SparseArray<Parcelable> implements Parcelable {
    public static final Creator<ParcelableSparseArray> CREATOR = ParcelableCompat.newCreator(new C07641());

    static class C07641 implements ParcelableCompatCreatorCallbacks<ParcelableSparseArray> {
        C07641() {
        }
