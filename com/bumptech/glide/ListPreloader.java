...
public class ListPreloader<T> implements OnScrollListener {
    ...
    class C08561 implements PreloadModelProvider<T> {
        C08561() {
        }
    ...
    class C08572 implements PreloadSizeProvider<T> {
        C08572() {
        }
    ...
    public ListPreloader(int maxPreload) {
        ...
        this.preloadModelProvider = new C08561();
        this.preloadDimensionProvider = new C08572();
