...
public abstract class Downsampler implements BitmapDecoder<InputStream> {
    public static final Downsampler AT_LEAST = new C11871();
    public static final Downsampler AT_MOST = new C11882();
    private static final int MARK_POSITION = 5242880;
    public static final Downsampler NONE = new C11893();
    ...
    static class C11871 extends Downsampler {
        C11871() {
        }
    ...
    static class C11882 extends Downsampler {
        C11882() {
        }
    ...
    static class C11893 extends Downsampler {
        C11893() {
        }
