...
class DevicePowerStateListener {
    ...
    class C02651 extends BroadcastReceiver {
        C02651() {
        }
    ...
    class C02662 extends BroadcastReceiver {
        C02662() {
        }
    ...
    public DevicePowerStateListener(Context context) {
        ...
        this.powerConnectedReceiver = new C02651();
        this.powerDisconnectedReceiver = new C02662();
