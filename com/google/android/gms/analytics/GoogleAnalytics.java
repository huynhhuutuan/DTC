...
public final class GoogleAnalytics extends zza {
    ...
    public void setLogger(Logger logger) {
        ...
        if (!this.zzabL) {
            ...
            Log.i((String) zzsw.zzafl.get(), new StringBuilder(String.valueOf(str).length() + 112).append("GoogleAnalytics.setLogger() is deprecated. To enable debug logging, please run:\nadb shell setprop log.tag.").append(str).append(" DEBUG").toString());
            this.zzabL = true;
        }
    }
