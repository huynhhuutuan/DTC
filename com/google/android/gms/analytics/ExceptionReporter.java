...
public class ExceptionReporter implements UncaughtExceptionHandler {
    ...
    public ExceptionReporter(Tracker tracker, UncaughtExceptionHandler uncaughtExceptionHandler, Context context) {
        if (tracker == null) {
            ...
            zztc.m10v(valueOf.length() != 0 ? str.concat(valueOf) : new String(str));
        }
    }
    ...
    public void uncaughtException(Thread thread, Throwable th) {
        ...
        zztc.m10v(valueOf.length() != 0 ? str2.concat(valueOf) : new String(str2));
        ...
        zzmu.zzmz();
        if (this.zzabC != null) {
            zztc.m10v("Passing exception to the original handler");
