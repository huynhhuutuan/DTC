...
public class zzd extends zzj implements OnBufferingUpdateListener, OnCompletionListener, OnErrorListener, OnInfoListener, OnPreparedListener, OnVideoSizeChangedListener, SurfaceTextureListener {
    ...
    class C03401 implements Runnable {
        ...
        C03401(zzd com_google_android_gms_ads_internal_overlay_zzd) {
    ...
    class C03412 implements Runnable {
        ...
        C03412(zzd com_google_android_gms_ads_internal_overlay_zzd) {
            this.zzNa = com_google_android_gms_ads_internal_overlay_zzd;
        }
    ...
    class C03434 implements Runnable {
        ...
        C03434(zzd com_google_android_gms_ads_internal_overlay_zzd) {
            this.zzNa = com_google_android_gms_ads_internal_overlay_zzd;
        }
    ...
    class C03456 implements Runnable {
        ...
        C03456(zzd com_google_android_gms_ads_internal_overlay_zzd) {
            this.zzNa = com_google_android_gms_ads_internal_overlay_zzd;
        }
    ...
    class C03467 implements Runnable {
        ...
        C03467(zzd com_google_android_gms_ads_internal_overlay_zzd) {
            this.zzNa = com_google_android_gms_ads_internal_overlay_zzd;
        }
    ...
    class C03478 implements Runnable {
        final /* synthetic */ zzd zzNa;

        C03478(zzd com_google_android_gms_ads_internal_overlay_zzd) {
            this.zzNa = com_google_android_gms_ads_internal_overlay_zzd;
        }
    ...
    private void zzhA() {
        if (this.zzMM && zzhB() && this.zzMP.getCurrentPosition() > 0 && this.zzMO != 3) {
            zzpk.m28v("AdMediaPlayerView nudging MediaPlayer");
            zza(0.0f);
            this.zzMP.start();
    ...
    private void zzhz() {
        Throwable e;
        String valueOf;
        zzpk.m28v("AdMediaPlayerView init MediaPlayer");
    ...
    private void zzy(boolean z) {
        zzpk.m28v("AdMediaPlayerView release");
        if (this.zzMW != null) {
            this.zzMW.zzil();
            this.zzMW = null;
        }
    ...
    public void onCompletion(MediaPlayer mediaPlayer) {
        zzpk.m28v("AdMediaPlayerView completion");
        zzK(5);
        zzL(5);
        zzpo.zzXC.post(new C03412(this));
    }
    ...
    public boolean onInfo(MediaPlayer mediaPlayer, int i, int i2) {
        ...
        zzpk.m28v(new StringBuilder((String.valueOf(str).length() + 37) + String.valueOf(str2).length()).append("AdMediaPlayerView MediaPlayer info: ").append(str).append(":").append(str2).toString());
        return true;
    }
    ...
    public void onPrepared(MediaPlayer mediaPlayer) {
        zzpk.m28v("AdMediaPlayerView prepared");
        zzK(2);
        this.zzML.zzhU();
        zzpo.zzXC.post(new C03401(this));
    ...
    public void onSurfaceTextureAvailable(SurfaceTexture surfaceTexture, int i, int i2) {
        zzpk.m28v("AdMediaPlayerView surface created");
        zzhz();
        zzpo.zzXC.post(new C03434(this));
    }

    public boolean onSurfaceTextureDestroyed(SurfaceTexture surfaceTexture) {
        zzpk.m28v("AdMediaPlayerView surface destroyed");
        ...
        zzpo.zzXC.post(new C03456(this));
        zzy(true);
        return true;
    }
    ...
    public void onSurfaceTextureSizeChanged(SurfaceTexture surfaceTexture, final int i, final int i2) {
        Object obj = 1;
        zzpk.m28v("AdMediaPlayerView surface changed");
    ...
    public void onVideoSizeChanged(MediaPlayer mediaPlayer, int i, int i2) {
        zzpk.m28v("AdMediaPlayerView size changed: " + i + " x " + i2);
        this.zzMR = mediaPlayer.getVideoWidth();
        this.zzMS = mediaPlayer.getVideoHeight();
    ...
    public void pause() {
        zzpk.m28v("AdMediaPlayerView pause");
        if (zzhB() && this.zzMP.isPlaying()) {
            this.zzMP.pause();
            zzK(4);
            zzpo.zzXC.post(new C03478(this));
        }
        zzL(4);
    }

    public void play() {
        zzpk.m28v("AdMediaPlayerView play");
        if (zzhB()) {
            this.zzMP.start();
            zzK(3);
            this.zzNR.zzhV();
            zzpo.zzXC.post(new C03467(this));
        }
        zzL(3);
    }

    public void seekTo(int i) {
        zzpk.m28v("AdMediaPlayerView seek " + i);
        if (zzhB()) {
            this.zzMP.seekTo(i);
            this.zzMY = 0;
            return;
    ...
    public void stop() {
        zzpk.m28v("AdMediaPlayerView stop");
        if (this.zzMP != null) {
            this.zzMP.stop();
            this.zzMP.release();
            this.zzMP = null;
