...
public class zzg extends zzc implements OnGlobalLayoutListener, OnScrollChangedListener {
    ...
    class C03691 implements Runnable {
        ...
        C03691(zzg com_google_android_gms_ads_internal_zzg) {
    ...
    private void zze(final zzpb com_google_android_gms_internal_zzpb) {
        zzt.zzzg();
        if (this.zzss.zzdq()) {
            if (com_google_android_gms_internal_zzpb.zzNH != null) {
                ...
                final zzcy com_google_android_gms_internal_zzcy = new zzcy(this.zzss.zzqn, com_google_android_gms_internal_zzpb.zzNH.getView());
                if (zzw.zzdl().zzjR()) {
    ...
    public boolean zza(@Nullable zzpb com_google_android_gms_internal_zzpb, final zzpb com_google_android_gms_internal_zzpb2) {
