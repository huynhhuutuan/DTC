...
public class zzq extends zza {
    ...
    public void zzb(IObjectWrapper iObjectWrapper, String str) {
        if (iObjectWrapper == null) {
            zzqf.m9e("Wrapped context is null. Failed to open debug menu.");
            return;
        }
        Context context = (Context) zzd.zzF(iObjectWrapper);
        if (context == null) {
            zzqf.m9e("Context is null. Failed to open debug menu.");
            return;
        }
            ...
            if (((Boolean) zzgd.zzCN.get()).booleanValue()) {
                ...
                runnable = new Runnable(this) {
                    ...
                    class C03731 implements Runnable {
                        ...
                        public void run() {
                            zzod.zza(this.zzuf.zzue.mContext, runnable);
                        }
                    }

                    public void run() {
                        zzw.zzcM().runOnUiThread(new C03731(this));
                    }
                };
                i = 1;
            } else {
