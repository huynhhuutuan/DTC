...
public class zzl {
    public static boolean zza(PublicKey publicKey, String str, String str2) {
        try {
            ...
            zzqf.m9e("Signature verification failed.");
            return false;
        } catch (NoSuchAlgorithmException e) {
            zzqf.m9e("NoSuchAlgorithmException.");
            return false;
        } catch (InvalidKeyException e2) {
            zzqf.m9e("Invalid key specification.");
            return false;
        } catch (SignatureException e3) {
            zzqf.m9e("Signature exception.");
            return false;
        }
    }
    ...
    public static boolean zzb(String str, String str2, String str3) {
        ...
        zzqf.m9e("Purchase verification failed: missing data.");
        return false;
    }
}
