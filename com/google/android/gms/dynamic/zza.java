...
public abstract class zza<T extends LifecycleDelegate> {
    ...
    private final zze<T> zzaRD = new C09121(this);

    class C03975 implements OnClickListener {
        final /* synthetic */ Intent zzaRJ;
        final /* synthetic */ Context zztf;

        C03975(Context context, Intent intent) {
            this.zztf = context;
            this.zzaRJ = intent;
        }
    ...
    class C09121 implements zze<T> {
        final /* synthetic */ zza zzaRE;

        C09121(zza com_google_android_gms_dynamic_zza) {
    ...
    class C09166 implements zza {
        final /* synthetic */ zza zzaRE;

        C09166(zza com_google_android_gms_dynamic_zza) {
            this.zzaRE = com_google_android_gms_dynamic_zza;
        }
    ...
    class C09177 implements zza {
        final /* synthetic */ zza zzaRE;

        C09177(zza com_google_android_gms_dynamic_zza) {
            this.zzaRE = com_google_android_gms_dynamic_zza;
        }
    ...
    static void zza(FrameLayout frameLayout, GoogleApiAvailability googleApiAvailability) {
        ...
        if (zzb != null) {
            ...
            button.setOnClickListener(new C03975(context, zzb));
        }
    }
