...
public final class LocationSettingsRequest extends zza {
    ...
    public static final class Builder {
        ...
        public LocationSettingsRequest build() {
            return new LocationSettingsRequest(this.zzbkl, this.zzbki, this.zzbkj, null);
        }
    ...
    LocationSettingsRequest(List<LocationRequest> list, boolean z, boolean z2, zzo com_google_android_gms_location_zzo) {
        this.zzaWt = list;
        this.zzbki = z;
        this.zzbkj = z2;
        this.zzbkk = com_google_android_gms_location_zzo;
    }
