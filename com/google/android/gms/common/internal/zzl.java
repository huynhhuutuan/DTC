...
public abstract class zzl<T extends IInterface> extends zzf<T> implements zze, zza {
    ...
    class C09101 implements zzb {
        final /* synthetic */ ConnectionCallbacks zzaFS;

        C09101(ConnectionCallbacks connectionCallbacks) {
    ...
    class C09112 implements zzc {
        final /* synthetic */ OnConnectionFailedListener zzaFT;

        C09112(OnConnectionFailedListener onConnectionFailedListener) {
    ...
    private static zzb zza(ConnectionCallbacks connectionCallbacks) {
        return connectionCallbacks == null ? null : new C09101(connectionCallbacks);
    }

    @Nullable
    private static zzc zza(OnConnectionFailedListener onConnectionFailedListener) {
        return onConnectionFailedListener == null ? null : new C09112(onConnectionFailedListener);
    }
