...
public final class TileOverlayOptions extends zza {
    ...
    class C11301 implements TileProvider {
        private final zzi zzbqd = this.zzbqe.zzbqa;
        final /* synthetic */ TileOverlayOptions zzbqe;

        C11301(TileOverlayOptions tileOverlayOptions) {
            this.zzbqe = tileOverlayOptions;
        }
    ...
    TileOverlayOptions(IBinder iBinder, boolean z, float f, boolean z2, float f2) {
        ...
        this.zzbqb = this.zzbqa == null ? null : new C11301(this);
        this.zzbpn = z;
        this.zzbpm = f;
        this.zzbqc = z2;
        this.zzbpv = f2;
