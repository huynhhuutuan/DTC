...
public class zzdb {
    ...
    public boolean equals(Object obj) {
        ...
        zzdb com_google_android_gms_internal_zzdb = (zzdb) obj;
        return com_google_android_gms_internal_zzdb.zzea() != null && com_google_android_gms_internal_zzdb.zzea().equals(zzea());
    }
    ...
    public void zza(String str, boolean z, float f, float f2, float f3, float f4) {
        ...
        synchronized (this.zzrJ) {
            if (this.zzxz < 0) {
                zzqf.zzbf("ActivityContent: negative number of WebViews.");
            }
            zzeg();
        }
    }
