...
class zzaua extends zzauh {
    ...
    String zzfH(String str) {
        ...
        if (zzaut.zzch(CommonUtils.MD5_INSTANCE) == null) {
            return null;
        }
        return String.format(Locale.US, "%032X", new Object[]{new BigInteger(1, zzaut.zzch(CommonUtils.MD5_INSTANCE).digest(str2.getBytes()))});
    }
