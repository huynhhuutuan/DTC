...
public final class zzej {
    ...
    public zzej(Context context, AttributeSet attributeSet) {
        Object obj = 1;
        TypedArray obtainAttributes = context.getResources().obtainAttributes(attributeSet, C0334R.styleable.AdsAttrs);
        Object string = obtainAttributes.getString(C0334R.styleable.AdsAttrs_adSize);
        Object string2 = obtainAttributes.getString(C0334R.styleable.AdsAttrs_adSizes);
        ...
        this.zzts = obtainAttributes.getString(C0334R.styleable.AdsAttrs_adUnitId);
