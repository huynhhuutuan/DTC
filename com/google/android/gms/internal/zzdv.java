...
public interface zzdv extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzdv {
        ...
        private static class zza implements zzdv {
            ...
            public zzdp zza(zzds com_google_android_gms_internal_zzds) throws RemoteException {
    ...
    zzdp zza(zzds com_google_android_gms_internal_zzds) throws RemoteException;
}
