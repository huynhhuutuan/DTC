...
public class zzpo {
    ...
    public String zza(Context context, View view, zzeg com_google_android_gms_internal_zzeg) {
        ...
        if (((Boolean) zzgd.zzCz.get()).booleanValue()) {
            try {
                ...
                jSONObject2.put(SettingsJsonConstants.ICON_WIDTH_KEY, com_google_android_gms_internal_zzeg.width);
                jSONObject2.put(SettingsJsonConstants.ICON_HEIGHT_KEY, com_google_android_gms_internal_zzeg.height);
    ...
    public void zza(final Context context, final List<String> list) {
        ...
        if (list == null) {
            zzpk.m28v("Cannot ping urls: empty list.");
        } else if (zzgr.zzo(context)) {
            final zzgr com_google_android_gms_internal_zzgr = new zzgr();
            com_google_android_gms_internal_zzgr.zza(new com.google.android.gms.internal.zzgr.zza(this) {
                public void zzfJ() {
                    for (String str : list) {
                        String str2 = "Pinging url: ";
                        String valueOf = String.valueOf(str);
                        zzqf.zzbg(valueOf.length() != 0 ? str2.concat(valueOf) : new String(str2));
                        com_google_android_gms_internal_zzgr.mayLaunchUrl(Uri.parse(str), null, null);
                    }
                    com_google_android_gms_internal_zzgr.zzd((Activity) context);
                }
            ...
            zzpk.m28v("Cannot ping url because custom tabs is not supported");
        }
    }
    ...
    public boolean zza(Activity activity, Configuration configuration) {
        ...
        identifier = ((Integer) zzgd.zzFs.get()).intValue() * ((int) Math.round(((double) activity.getResources().getDisplayMetrics().density) + 0.5d));
            ...
            if (this.zzIA != null) {
                ...
                if (TextUtils.isEmpty(this.zzIA)) {
                    if (zzel.zzeT().zzlj()) {
                        ...
                        this.zzIA = null;
                        zzXC.post(new Runnable(this) {
                            final /* synthetic */ zzpo zzXH;

                            public void run() {
                                synchronized (this.zzXH.zzrJ) {
                                    this.zzXH.zzIA = this.zzXH.zzL(context);
