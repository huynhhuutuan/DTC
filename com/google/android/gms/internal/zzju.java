...
public class zzju implements zza {
    ...
    public zzjv zza(long j, long j2) {
        ...
        synchronized (this.zzrJ) {
            long elapsedRealtime = SystemClock.elapsedRealtime();
            final zzjt com_google_android_gms_internal_zzjt = new zzjt();
                ...
                public void run() {
                    synchronized (this.zzLf.zzrJ) {
                        ...
                        if (this.zzLf.zzLb == null) {
                            ...
                            com_google_android_gms_internal_zzjt.zza(this.zzLf);
                            this.zzLf.zza(com_google_android_gms_internal_zzjt);
                        } else {
