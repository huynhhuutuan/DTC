...
public class zzgx extends zza implements zzha.zza {
    ...
    class C10441 implements zzgy {
        final /* synthetic */ zzgx zzGG;

        C10441(zzgx com_google_android_gms_internal_zzgx) {
    ...
    public void performClick(String str) {
        synchronized (this.zzrJ) {
            if (this.zzGA == null) {
                zzqf.m9e("Attempt to call performClick before ad initialized.");
                return;
            }
    ...
    public void recordImpression() {
        synchronized (this.zzrJ) {
            if (this.zzGA == null) {
                zzqf.m9e("Attempt to perform recordImpression before ad initialized.");
                return;
            }
    ...
    public boolean zzj(IObjectWrapper iObjectWrapper) {
        if (this.zzGA == null) {
            zzqf.m9e("Attempt to call renderVideoInMediaView before ad initialized.");
            return false;
        } else if (this.zzGz == null) {
            return false;
        } else {
            View view = (FrameLayout) zzd.zzF(iObjectWrapper);
            this.zzGA.zza(view, new C10441(this));
            return true;
        }
    }
}
