...
public class zzhb implements zzha {
    ...
    private static class zza {
        ...
        class C10525 extends com.google.android.gms.internal.zzlw.zza {
            final /* synthetic */ zza zzGX;

            C10525(zza com_google_android_gms_internal_zzhb_zza) {
        ...
        private zzid zzf(final zzjj com_google_android_gms_internal_zzjj) {
            return new zzid(this) {
                final /* synthetic */ zza zzGX;

                public void zza(zzqw com_google_android_gms_internal_zzqw, final Map<String, String> map) {
                    zzqw com_google_android_gms_internal_zzqw2 = (zzqw) this.zzGX.zzGU.get();
                    if (com_google_android_gms_internal_zzqw2 == null) {
                        com_google_android_gms_internal_zzjj.zzb("/loadHtml", (zzid) this);
                        return;
                    }
                    com_google_android_gms_internal_zzqw2.zzlv().zza(new com.google.android.gms.internal.zzqx.zza(this) {
                        final /* synthetic */ C10481 zzGZ;

                        public void zza(zzqw com_google_android_gms_internal_zzqw, boolean z) {
                            this.zzGZ.zzGX.zzGV = (String) map.get("id");
                            JSONObject jSONObject = new JSONObject();
                            try {
                                jSONObject.put("messageType", "htmlLoaded");
                                jSONObject.put("id", this.zzGZ.zzGX.zzGV);
                                com_google_android_gms_internal_zzjj.zzb("sendMessageToNativeJs", jSONObject);
                            } catch (Throwable e) {
        ...
        private zzid zzg(final zzjj com_google_android_gms_internal_zzjj) {
            return new zzid(this) {
                final /* synthetic */ zza zzGX;
                ...
                public void zza(zzqw com_google_android_gms_internal_zzqw, Map<String, String> map) {
                    zzqw com_google_android_gms_internal_zzqw2 = (zzqw) this.zzGX.zzGU.get();
                    if (com_google_android_gms_internal_zzqw2 == null) {
                        com_google_android_gms_internal_zzjj.zzb("/showOverlay", (zzid) this);
                    } else {
        ...
        private zzid zzh(final zzjj com_google_android_gms_internal_zzjj) {
            return new zzid(this) {
                final /* synthetic */ zza zzGX;
                ...
                public void zza(zzqw com_google_android_gms_internal_zzqw, Map<String, String> map) {
                    zzqw com_google_android_gms_internal_zzqw2 = (zzqw) this.zzGX.zzGU.get();
                    if (com_google_android_gms_internal_zzqw2 == null) {
                        com_google_android_gms_internal_zzjj.zzb("/hideOverlay", (zzid) this);
                    } else {
        ...
        private zzid zzi(final zzjj com_google_android_gms_internal_zzjj) {
            return new zzid(this) {
                final /* synthetic */ zza zzGX;
                ...
                public void zza(zzqw com_google_android_gms_internal_zzqw, Map<String, String> map) {
                    ...
                    try {
                        ...
                        jSONObject.put("id", this.zzGX.zzGV);
                        com_google_android_gms_internal_zzjj.zzb("sendMessageToNativeJs", jSONObject);
                    } catch (Throwable e) {
                        zzqf.zzb("Unable to dispatch sendMessageToNativeJs event", e);
                    }
        ...
        try {
            ...
            for (Entry entry : map.entrySet()) {
                ...
                if (view2 != null) {
                    ...
                    jSONObject2.put(SettingsJsonConstants.ICON_WIDTH_KEY, zzC(zzl(view2)));
                    jSONObject2.put(SettingsJsonConstants.ICON_HEIGHT_KEY, zzC(zzm(view2)));
    ...
    private JSONObject zzb(Rect rect) throws JSONException {
        ...
        jSONObject.put(SettingsJsonConstants.ICON_WIDTH_KEY, zzC(rect.right - rect.left));
        jSONObject.put(SettingsJsonConstants.ICON_HEIGHT_KEY, zzC(rect.bottom - rect.top));
    ...
    private JSONObject zzb(Map<String, WeakReference<View>> map, View view) {
        ...
        for (Entry entry : map.entrySet()) {
            ...
            if (view2 != null) {
                ...
                try {
                    Object zzb;
                    jSONObject3.put(SettingsJsonConstants.ICON_WIDTH_KEY, zzC(zzl(view2)));
                    jSONObject3.put(SettingsJsonConstants.ICON_HEIGHT_KEY, zzC(zzm(view2)));
    ...
    private JSONObject zzn(View view) {
        ...
        if (view != null) {
            try {
                jSONObject.put(SettingsJsonConstants.ICON_WIDTH_KEY, zzC(zzl(view)));
                jSONObject.put(SettingsJsonConstants.ICON_HEIGHT_KEY, zzC(zzm(view)));
            } catch (Exception e) {
    ...
    private JSONObject zzo(View view) {
        ...
        if (view != null) {
            try {
                ...
                int[] zzk = zzk(view);
                JSONObject jSONObject2 = new JSONObject();
                jSONObject2.put(SettingsJsonConstants.ICON_WIDTH_KEY, zzC(zzl(view)));
                jSONObject2.put(SettingsJsonConstants.ICON_HEIGHT_KEY, zzC(zzm(view)));
    ...
    public void zza(View view, String str, @Nullable JSONObject jSONObject, Map<String, WeakReference<View>> map, View view2) {
        ...
        try {
            ...
            this.zzGN.zza(new com.google.android.gms.internal.zzlw.zza(this) {
                public void zze(zzjj com_google_android_gms_internal_zzjj) {
                    com_google_android_gms_internal_zzjj.zza("google.afma.nativeAds.handleClickGmsg", jSONObject3);
                }
            });
        } catch (Throwable e2) {
    ...
    public void zzb(View view, Map<String, WeakReference<View>> map) {
        ...
        try {
            ...
            this.zzGN.zza(new com.google.android.gms.internal.zzlw.zza(this) {
                public void zze(zzjj com_google_android_gms_internal_zzjj) {
                    com_google_android_gms_internal_zzjj.zza("google.afma.nativeAds.handleImpressionPing", jSONObject);
                }
            });
        } catch (Throwable e) {
