...
public interface zzle extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzle {
        ...
        private static class zza implements zzle {
        ...
        public static zzle zzX(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzle)) ? new zza(iBinder) : (zzle) queryLocalInterface;
        }
    ...
    void zza(zzld com_google_android_gms_internal_zzld) throws RemoteException;
}
