...
public class zzasb implements GeofencingApi {
    ...
    public PendingResult<Status> addGeofences(GoogleApiClient googleApiClient, final GeofencingRequest geofencingRequest, final PendingIntent pendingIntent) {
        return googleApiClient.zzb(new zza(this, googleApiClient) {
            protected void zza(zzash com_google_android_gms_internal_zzash) throws RemoteException {
                com_google_android_gms_internal_zzash.zza(geofencingRequest, pendingIntent, (zzb) this);
            }
        });
    }
    ...
    public PendingResult<Status> zza(GoogleApiClient googleApiClient, final zzt com_google_android_gms_location_zzt) {
        return googleApiClient.zzb(new zza(this, googleApiClient) {
            protected void zza(zzash com_google_android_gms_internal_zzash) throws RemoteException {
                com_google_android_gms_internal_zzash.zza(com_google_android_gms_location_zzt, (zzb) this);
            }
        });
    }
}
