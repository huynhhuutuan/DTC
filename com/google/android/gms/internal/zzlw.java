...
public class zzlw {
    ...
    class C10963 implements zzpt<zzjf> {
        final /* synthetic */ zzlw zzQt;

        C10963(zzlw com_google_android_gms_internal_zzlw) {
    ...
    private void zziV() {
        synchronized (zztX) {
            if (!zzQm) {
                zzQn = new zzji(this.mContext.getApplicationContext() != null ? this.mContext.getApplicationContext() : this.mContext, this.zzuc, (String) zzgd.zzEj.get(), new C10963(this), new zzb());
                zzQm = true;
            }
        }
    }
    ...
    public void zza(final zza com_google_android_gms_internal_zzlw_zza) {
        if (this.zzQr) {
            zze zzjc = zzjc();
            if (zzjc == null) {
                ...
                zzjc.zza(new zzc<zzjj>(this) {
                    public void zzb(zzjj com_google_android_gms_internal_zzjj) {
                        com_google_android_gms_internal_zzlw_zza.zze(com_google_android_gms_internal_zzjj);
                    }
                    ...
                    public void run() {
                        com_google_android_gms_internal_zzlw_zza.zzjd();
                    }
                });
                return;
            }
