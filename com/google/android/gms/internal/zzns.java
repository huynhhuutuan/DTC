...
public class zzns extends zzb implements zzoh {
    ...
    class C06141 implements Runnable {
        ...
        C06141(zzns com_google_android_gms_internal_zzns) {
    ...
    private zza zzd(zza com_google_android_gms_internal_zzpb_zza) {
        zzpk.m28v("Creating mediation ad response for non-mediated rewarded ad.");
        try {
            ...
            return new zza(com_google_android_gms_internal_zzpb_zza.zzTi, com_google_android_gms_internal_zzpb_zza.zzWm, new zzjr(Arrays.asList(new zzjq[]{com_google_android_gms_internal_zzjq}), ((Long) zzgd.zzDM.get()).longValue(), Collections.emptyList(), Collections.emptyList(), Collections.emptyList(), Collections.emptyList(), false, "", -1, 0, 1, null, 0, -1, -1, false), com_google_android_gms_internal_zzpb_zza.zzvr, com_google_android_gms_internal_zzpb_zza.errorCode, com_google_android_gms_internal_zzpb_zza.zzWg, com_google_android_gms_internal_zzpb_zza.zzWh, com_google_android_gms_internal_zzpb_zza.zzWa);
        } catch (Throwable e) {
    ...
    public void zza(zzoa com_google_android_gms_internal_zzoa) {
        ...
        if (TextUtils.isEmpty(com_google_android_gms_internal_zzoa.zzvl)) {
            ...
            zzpo.zzXC.post(new C06141(this));
            return;
        }
        this.zzVn = false;
    ...
    public void zza(final zza com_google_android_gms_internal_zzpb_zza, zzgl com_google_android_gms_internal_zzgl) {
        if (com_google_android_gms_internal_zzpb_zza.errorCode != -2) {
            zzpo.zzXC.post(new Runnable(this) {
                final /* synthetic */ zzns zzVo;

                public void run() {
                    this.zzVo.zzb(new zzpb(com_google_android_gms_internal_zzpb_zza, null, null, null, null, null, null, null));
                }
            });
            return;
        }
