...
public final class zzats {
    ...
    public static zza<Integer> zzbsc = zza.zzB("measurement.upload.max_events_per_day", 100000);
    ...
    public static zza<Integer> zzbsh = zza.zzB("measurement.store.max_stored_events_per_app", 100000);
    ...
    public static zza<Long> zzbsp = zza.zzj("measurement.alarm_manager.minimum_interval", 60000);
    ...
    public static zza<Long> zzbsy = zza.zzj("measurement.service_client.idle_disconnect_millis", 5000);
