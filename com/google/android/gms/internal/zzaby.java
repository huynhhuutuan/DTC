...
public class zzaby {
    ...
    private final zzb zzaDx = new C09381(this);

    interface zzb {
        void zzc(zzaaf<?> com_google_android_gms_internal_zzaaf_);
    }

    class C09381 implements zzb {
        final /* synthetic */ zzaby zzaDy;

        C09381(zzaby com_google_android_gms_internal_zzaby) {
            this.zzaDy = com_google_android_gms_internal_zzaby;
        }
