    ...
    static HttpUriRequest zzb(zzl<?> com_google_android_gms_internal_zzl_, Map<String, String> map) throws zza {
        ...
        switch (com_google_android_gms_internal_zzl_.getMethod()) {
            case -1:
                ...
                httpPost2.addHeader(HttpRequest.HEADER_CONTENT_TYPE, com_google_android_gms_internal_zzl_.zzi());
            ...
            case 1:
                ...
                httpPost.addHeader(HttpRequest.HEADER_CONTENT_TYPE, com_google_android_gms_internal_zzl_.zzl());
