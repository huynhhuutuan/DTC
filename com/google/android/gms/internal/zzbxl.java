...
public final class zzbxl {
    ...
    private int zzcut;
    private int zzcuu;
    private int zzcuv = ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED;
    private int zzcuw;
    ...
    public int zzaeB() {
        if (this.zzcuv == ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED) {
            return -1;
        }
    ...
    public int zzaew() throws IOException {
        ...
        int i = zzaeD & TransportMediator.KEYCODE_MEDIA_PAUSE;
        byte zzaeD2 = zzaeD();
        if (zzaeD2 >= (byte) 0) {
            return i | (zzaeD2 << 7);
        }
        i |= (zzaeD2 & TransportMediator.KEYCODE_MEDIA_PAUSE) << 7;
        zzaeD2 = zzaeD();
        if (zzaeD2 >= (byte) 0) {
            return i | (zzaeD2 << 14);
        }
        i |= (zzaeD2 & TransportMediator.KEYCODE_MEDIA_PAUSE) << 14;
        zzaeD2 = zzaeD();
        if (zzaeD2 >= (byte) 0) {
            return i | (zzaeD2 << 21);
        }
        i |= (zzaeD2 & TransportMediator.KEYCODE_MEDIA_PAUSE) << 21;
        zzaeD2 = zzaeD();
        i |= zzaeD2 << 28;
        if (zzaeD2 >= (byte) 0) {
            return i;
    ...
    public long zzaex() throws IOException {
        ...
        for (int i = 0; i < 64; i += 7) {
            byte zzaeD = zzaeD();
            j |= ((long) (zzaeD & TransportMediator.KEYCODE_MEDIA_PAUSE)) << i;
            if ((zzaeD & 128) == 0) {
                return j;
            }
        }
