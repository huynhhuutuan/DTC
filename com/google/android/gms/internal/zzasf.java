...
public interface zzasf extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzasf {
        ...
        private static class zza implements zzasf {
        ...
        public static zzasf zzdj(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzasf)) ? new zza(iBinder) : (zzasf) queryLocalInterface;
        }
