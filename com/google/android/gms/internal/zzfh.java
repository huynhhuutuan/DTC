...
public class zzfh {
    ...
    public void zza(final Context context, String str, zzfi com_google_android_gms_internal_zzfi) {
        synchronized (zztX) {
            if (this.zzAz != null) {
                ...
                try {
                    ...
                    if (str != null) {
                        this.zzAz.zzc(str, zzd.zzA(new Runnable(this) {
                            final /* synthetic */ zzfh zzAB;

                            public void run() {
                                this.zzAB.getRewardedVideoAdInstance(context);
                            }
                        }));
                    }
                } catch (Throwable e) {
