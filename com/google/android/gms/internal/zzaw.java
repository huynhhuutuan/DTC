...
public class zzaw {
    private static final String[] zzqc = new String[]{"/aclk", "/pcs/click"};
    private String zzpY = "googleads.g.doubleclick.net";
    private String zzpZ = "/pagead/ads";
    private String zzqa = "ad.doubleclick.net";
    private String[] zzqb = new String[]{".doubleclick.net", ".googleadservices.com", ".googlesyndication.com"};
    private zzar zzqd;

    public zzaw(zzar com_google_android_gms_internal_zzar) {
        this.zzqd = com_google_android_gms_internal_zzar;
    }
