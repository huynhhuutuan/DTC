...
public class zzaa implements zzz {
        ...
        switch (com_google_android_gms_internal_zzl_.getMethod()) {
            case -1:
                ...
                if (zzj != null) {
                    ...
                    httpURLConnection.addRequestProperty(HttpRequest.HEADER_CONTENT_TYPE, com_google_android_gms_internal_zzl_.zzi());
    ...
    private static void zzb(HttpURLConnection httpURLConnection, zzl<?> com_google_android_gms_internal_zzl_) throws IOException, zza {
        ...
        if (zzm != null) {
            httpURLConnection.setDoOutput(true);
            httpURLConnection.addRequestProperty(HttpRequest.HEADER_CONTENT_TYPE, com_google_android_gms_internal_zzl_.zzl());
            DataOutputStream dataOutputStream = new DataOutputStream(httpURLConnection.getOutputStream());
