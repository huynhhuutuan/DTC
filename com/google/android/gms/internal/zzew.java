...
public interface zzew extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzew {
        ...
        private static class zza implements zzew {
            ...
            public zzer createAdLoaderBuilder(IObjectWrapper iObjectWrapper, String str, zzka com_google_android_gms_internal_zzka, int i) throws RemoteException {
            ...
            public zzet createBannerAdManager(IObjectWrapper iObjectWrapper, zzeg com_google_android_gms_internal_zzeg, String str, zzka com_google_android_gms_internal_zzka, int i) throws RemoteException {
                IBinder iBinder = null;
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
            ...
            public zzet createInterstitialAdManager(IObjectWrapper iObjectWrapper, zzeg com_google_android_gms_internal_zzeg, String str, zzka com_google_android_gms_internal_zzka, int i) throws RemoteException {
                IBinder iBinder = null;
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
            ...
            public zznu createRewardedVideoAd(IObjectWrapper iObjectWrapper, zzka com_google_android_gms_internal_zzka, int i) throws RemoteException {
                IBinder iBinder = null;
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
            ...
            public zzet createSearchAdManager(IObjectWrapper iObjectWrapper, zzeg com_google_android_gms_internal_zzeg, String str, int i) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.ads.internal.client.IClientApi");
    ...
    zzer createAdLoaderBuilder(IObjectWrapper iObjectWrapper, String str, zzka com_google_android_gms_internal_zzka, int i) throws RemoteException;

    zzkz createAdOverlay(IObjectWrapper iObjectWrapper) throws RemoteException;

    zzet createBannerAdManager(IObjectWrapper iObjectWrapper, zzeg com_google_android_gms_internal_zzeg, String str, zzka com_google_android_gms_internal_zzka, int i) throws RemoteException;

    zzlf createInAppPurchaseManager(IObjectWrapper iObjectWrapper) throws RemoteException;

    zzet createInterstitialAdManager(IObjectWrapper iObjectWrapper, zzeg com_google_android_gms_internal_zzeg, String str, zzka com_google_android_gms_internal_zzka, int i) throws RemoteException;

    zzhh createNativeAdViewDelegate(IObjectWrapper iObjectWrapper, IObjectWrapper iObjectWrapper2) throws RemoteException;

    zznu createRewardedVideoAd(IObjectWrapper iObjectWrapper, zzka com_google_android_gms_internal_zzka, int i) throws RemoteException;

    zzet createSearchAdManager(IObjectWrapper iObjectWrapper, zzeg com_google_android_gms_internal_zzeg, String str, int i) throws RemoteException;
