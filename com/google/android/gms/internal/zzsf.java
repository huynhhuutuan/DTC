...
public class zzsf extends zzsa {
    private final zza zzael = new zza(this);
    private zzta zzaem;
...
*/
        ...
        public void onServiceDisconnected(final ComponentName componentName) {
            ...
            this.zzaep.zznU().zzg(new Runnable(this) {
                final /* synthetic */ zza zzaet;

                public void run() {
                    this.zzaet.zzaep.onServiceDisconnected(componentName);
                }
            });
        }
    ...
    protected zzsf(zzsc com_google_android_gms_internal_zzsc) {
        ...
        this.zzaen = new zzsr(this, com_google_android_gms_internal_zzsc) {
            final /* synthetic */ zzsf zzaep;
