...
public final class zzni {
    ...
    public static final class zza {
        ...
        public zza(Context context, zzni com_google_android_gms_internal_zzni) {
            context.getPackageManager();
            zzw(context);
            zzx(context);
            zzy(context);
            zzz(context);
            this.zzUF = com_google_android_gms_internal_zzni.zzUF;
            this.zzUG = com_google_android_gms_internal_zzni.zzUG;
            this.zzUI = com_google_android_gms_internal_zzni.zzUI;
            this.zzUJ = com_google_android_gms_internal_zzni.zzUJ;
            this.zzUK = com_google_android_gms_internal_zzni.zzUK;
            this.zzUN = com_google_android_gms_internal_zzni.zzUN;
            this.zzUO = com_google_android_gms_internal_zzni.zzUO;
            this.zzxk = com_google_android_gms_internal_zzni.zzxk;
            this.zzRH = com_google_android_gms_internal_zzni.zzRH;
            this.zzRI = com_google_android_gms_internal_zzni.zzRI;
        }
