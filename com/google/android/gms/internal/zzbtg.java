...
public class zzbtg {
    private static final ConcurrentMap<Class<?>, zza<?>> zzckP = new ConcurrentHashMap();

    private static class zza<T> {
        private final Class<T> zzckQ;
        private final Constructor<T> zzckR;
        private final boolean zzckS;
        private final boolean zzckT;
        private final Map<String, String> zzckU;
        private final Map<String, Method> zzckV;
        private final Map<String, Method> zzckW;
        private final Map<String, Field> zzckX;
        ...
        L_0x01e0:
            ...
            goto L_0x00ad;
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.zzbtg.zza.<init>(java.lang.Class):void");
        }
        ...
        private void zzjr(String str) {
            String str2 = (String) this.zzckU.put(str.toLowerCase(), str);
        ...
        public Map<String, Object> zzaH(T t) {
            if (this.zzckQ.isAssignableFrom(t.getClass())) {
                Map<String, Object> hashMap = new HashMap();
                for (String str : this.zzckU.values()) {
                    String str2;
                    Object invoke;
                    if (this.zzckV.containsKey(str2)) {
                        try {
                            invoke = ((Method) this.zzckV.get(str2)).invoke(t, new Object[0]);
                        } catch (Throwable e) {
                    ...
                    Field field = (Field) this.zzckX.get(str2);
                    if (field == null) {
                    ...
                    hashMap.put(str2, zzbtg.zzaz(invoke));
                }
                return hashMap;
            }
            String valueOf = String.valueOf(t.getClass());
            str3 = String.valueOf(this.zzckQ);
        ...
        public T zze(Map<String, Object> map, Map<TypeVariable<Class<T>>, Type> map2) {
            if (this.zzckR == null) {
                String valueOf = String.valueOf(this.zzckQ.getName());
            ...
            try {
                T newInstance = this.zzckR.newInstance(new Object[0]);
                for (Entry entry : map.entrySet()) {
                    valueOf = (String) entry.getKey();
                    if (this.zzckW.containsKey(valueOf)) {
                        Method method = (Method) this.zzckW.get(valueOf);
                        Type[] genericParameterTypes = method.getGenericParameterTypes();
                        if (genericParameterTypes.length != 1) {
                            throw new IllegalStateException("Setter does not have exactly one parameter");
                        }
                        Object zzb = zzbtg.zza(entry.getValue(), zza(genericParameterTypes[0], (Map) map2));
                        try {
                    ...
                    } else if (this.zzckX.containsKey(valueOf)) {
                        Field field = (Field) this.zzckX.get(valueOf);
                        try {
                            field.set(newInstance, zzbtg.zza(entry.getValue(), zza(field.getGenericType(), (Map) map2)));
                        } catch (Throwable e22) {
                            throw new RuntimeException(e22);
                        }
                    } else {
                        String valueOf2 = String.valueOf(this.zzckQ.getName());
                        ...
                        if (this.zzckU.containsKey(valueOf.toLowerCase())) {
    ...
    private static <T> T zza(Object obj, ParameterizedType parameterizedType) {
        ...
        if (List.class.isAssignableFrom(cls)) {
            ...
            TypeVariable[] typeParameters = zzi.zzckQ.getTypeParameters();
    ...
    private static <T> Object zzaz(T t) {
        if (t == null) {
            return null;
        }
        if (t instanceof Number) {
            ...
            if (t instanceof Character) {
                ...
                if (t instanceof List) {
                    ...
                    for (Object zzaz : list) {
                        arrayList.add(zzaz(zzaz));
                    }
                    return arrayList;
                }
                throw new DatabaseException("Serializing Collections is not supported, please use Lists instead");
            } else if (!t.getClass().isArray()) {
                return t instanceof Enum ? ((Enum) t).name() : zzi(t.getClass()).zzaH((Object) t);
            } else {
    ...
    private static <T> T zzc(Object obj, Class<T> cls) {
        ...
        if (Float.class.isAssignableFrom(cls) || Float.TYPE.isAssignableFrom(cls)) {
            return Float.valueOf(zzaD(obj).floatValue());
        }
    ...
    private static <T> zza<T> zzi(Class<T> cls) {
        zza<T> com_google_android_gms_internal_zzbtg_zza_T = (zza) zzckP.get(cls);
        if (com_google_android_gms_internal_zzbtg_zza_T != null) {
            return com_google_android_gms_internal_zzbtg_zza_T;
        }
        com_google_android_gms_internal_zzbtg_zza_T = new zza(cls);
        zzckP.put(cls, com_google_android_gms_internal_zzbtg_zza_T);
        return com_google_android_gms_internal_zzbtg_zza_T;
    }
}
