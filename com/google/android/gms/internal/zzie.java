...
public class zzie implements zzid {
    ...
    public void zza(final zzqw com_google_android_gms_internal_zzqw, final Map<String, String> map) {
        zzpn.zza(new Runnable(this) {
            final /* synthetic */ zzie zzIa;

            public void run() {
                zzqf.zzbf("Received Http request.");
                final JSONObject zzaa = this.zzIa.zzaa((String) map.get("http_request"));
                if (zzaa == null) {
                    zzqf.m9e("Response should not be null.");
                } else {
                    zzpo.zzXC.post(new Runnable(this) {
                        final /* synthetic */ C05501 zzIc;

                        public void run() {
                            com_google_android_gms_internal_zzqw.zzb("fetchHttpRequestCompleted", zzaa);
    ...
    public JSONObject zzaa(String str) {
        try {
            ...
            zzqf.m9e("The request is not a valid JSON.");
            try {
