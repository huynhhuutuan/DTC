...
class zzatj extends zzauh {
    ...
    static {
        zzbrk.put(Param.ORIGIN, "ALTER TABLE user_attributes ADD COLUMN origin TEXT;");
    ...
    public boolean zza(zzatg com_google_android_gms_internal_zzatg) {
        ...
        contentValues.put(Param.ORIGIN, com_google_android_gms_internal_zzatg.zzbqZ);
    ...
    public boolean zza(zzaus com_google_android_gms_internal_zzaus) {
        ...
        contentValues.put(Param.ORIGIN, com_google_android_gms_internal_zzaus.mOrigin);
    ...
    public List<zzatg> zzc(String str, String[] strArr) {
        ...
        try {
            ...
            zzKm().zzKY();
            query = getWritableDatabase().query("conditional_properties", strArr2, str, strArr, null, null, "rowid", String.valueOf(1001));
            try {
                if (query.moveToFirst()) {
                    do {
    ...
    public List<zzaus> zzft(String str) {
        ...
        try {
            Cursor query = getWritableDatabase().query("user_attributes", new String[]{"name", Param.ORIGIN, "set_timestamp", Param.VALUE}, "app_id=?", new String[]{str}, null, null, "rowid", String.valueOf(zzKm().zzKW()));
            try {
                if (query.moveToFirst()) {
                    do {
                        String string = query.getString(0);
            ...
            if (query.moveToFirst()) {
                ...
                do {
                    ...
                    try {
                        ...
                        zzKk().zzLX().zzd("Failed to merge filter results. appId, audienceId, error", zzatx.zzfE(str), Integer.valueOf(i), e3);
                    }
                } while (query.moveToNext());
                if (query == null) {
                    return arrayMap;
    ...
    public List<zzaus> zzk(String str, String str2, String str3) {
        ...
        try {
            ...
            zzKm().zzKW();
            Cursor query = getWritableDatabase().query("user_attributes", strArr2, stringBuilder.toString(), strArr, null, null, "rowid", String.valueOf(1001));
            try {
                if (query.moveToFirst()) {
                    while (arrayList.size() < zzKm().zzKW()) {
                        ...
                        try {
                            ...
                            if (zzb == null) {
                                zzKk().zzLX().zzd("(2)Read invalid user property value, ignoring it", zzatx.zzfE(str), string, str3);
                            } else {
                                arrayList.add(new zzaus(str, string, string2, j, zzb));
                            }
                            if (!query.moveToNext()) {
                                break;
                            }
