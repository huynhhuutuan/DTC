...
public final class zzjr {
    ...
    public zzjr(JSONObject jSONObject) throws JSONException {
        ...
        for (int i2 = 0; i2 < jSONArray.length(); i2++) {
            zzjq com_google_android_gms_internal_zzjq = new zzjq(jSONArray.getJSONObject(i2));
            arrayList.add(com_google_android_gms_internal_zzjq);
            if (i < 0 && zza(com_google_android_gms_internal_zzjq)) {
                i = i2;
            }
        }
        this.zzKS = i;
    ...
    private boolean zza(zzjq com_google_android_gms_internal_zzjq) {
        for (String equals : com_google_android_gms_internal_zzjq.zzKp) {
