...
public interface zzasc extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzasc {
        ...
        private static class zza implements zzasc {
            ...
            public void zza(zzarz com_google_android_gms_internal_zzarz) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.location.internal.IFusedLocationProviderCallback");
                    if (com_google_android_gms_internal_zzarz != null) {
                        obtain.writeInt(1);
                        com_google_android_gms_internal_zzarz.writeToParcel(obtain, 0);
                    } else {
                        obtain.writeInt(0);
                    }
    ...
    void zza(zzarz com_google_android_gms_internal_zzarz) throws RemoteException;
}
