...
class zzcg implements zzaw {
    ...
    class zzb extends SQLiteOpenHelper {
        final /* synthetic */ zzcg zzbHc;
        private boolean zzbHd;
        private long zzbHe = 0;

        zzb(zzcg com_google_android_gms_tagmanager_zzcg, Context context, String str) {
            this.zzbHc = com_google_android_gms_tagmanager_zzcg;
        ...
        public SQLiteDatabase getWritableDatabase() {
            if (!this.zzbHd || this.zzbHe + 3600000 <= this.zzbHc.zzuP.currentTimeMillis()) {
                SQLiteDatabase sQLiteDatabase = null;
                this.zzbHd = true;
                this.zzbHe = this.zzbHc.zzuP.currentTimeMillis();
                try {
                    sQLiteDatabase = super.getWritableDatabase();
                } catch (SQLiteException e) {
                    this.zzbHc.mContext.getDatabasePath(this.zzbHc.zzbGZ).delete();
                }
    ...
    class zza implements com.google.android.gms.tagmanager.zzde.zza {
        ...
        public void zza(zzas com_google_android_gms_tagmanager_zzas) {
            this.zzbHc.zzv(com_google_android_gms_tagmanager_zzas.zzQM());
        }

        public void zzb(zzas com_google_android_gms_tagmanager_zzas) {
            this.zzbHc.zzv(com_google_android_gms_tagmanager_zzas.zzQM());
            zzbo.m12v("Permanent failure dispatching hitId: " + com_google_android_gms_tagmanager_zzas.zzQM());
        }

        public void zzc(zzas com_google_android_gms_tagmanager_zzas) {
            long zzQN = com_google_android_gms_tagmanager_zzas.zzQN();
            if (zzQN == 0) {
                this.zzbHc.zzj(com_google_android_gms_tagmanager_zzas.zzQM(), this.zzbHc.zzuP.currentTimeMillis());
            } else if (zzQN + 14400000 < this.zzbHc.zzuP.currentTimeMillis()) {
                this.zzbHc.zzv(com_google_android_gms_tagmanager_zzas.zzQM());
                zzbo.m12v("Giving up on failed hitId: " + com_google_android_gms_tagmanager_zzas.zzQM());
            }
        }
    }
    ...
    zzcg(zzax com_google_android_gms_tagmanager_zzax, Context context, String str, int i) {
        ...
        this.zzbGZ = str;
        this.zzbGY = com_google_android_gms_tagmanager_zzax;
        this.zzuP = zzi.zzzc();
        this.zzbGW = new zzb(this, this.mContext, this.zzbGZ);
        this.zzbGX = new zzde(this.mContext, new zza(this));
        this.zzbHa = 0;
        this.zzbHb = i;
    }

    private void zzQZ() {
        int zzRa = (zzRa() - this.zzbHb) + 1;
        if (zzRa > 0) {
            List zznG = zznG(zzRa);
            zzbo.m12v("Store full, deleting " + zznG.size() + " hits to make room.");
    ...
    private SQLiteDatabase zzhe(String str) {
        try {
            return this.zzbGW.getWritableDatabase();
        } catch (SQLiteException e) {
            zzbo.zzbh(str);
            return null;
        }
    ...
    public void dispatch() {
        zzbo.m12v("GTM Dispatch running...");
        if (this.zzbGX.zzQE()) {
            List zznH = zznH(40);
            if (zznH.isEmpty()) {
                zzbo.m12v("...nothing to dispatch");
        ...
        if (strArr != null && strArr.length != 0) {
            ...
            if (zzhe != null) {
                try {
                    ...
                    zzax com_google_android_gms_tagmanager_zzax = this.zzbGY;
                    if (zzRa() != 0) {
                        z = false;
                    }
    ...
    L_0x00fa:
        ...
        r2 = r12.get(r4);	 Catch:{ SQLiteException -> 0x0118, all -> 0x016d }
        r2 = (com.google.android.gms.tagmanager.zzas) r2;	 Catch:{ SQLiteException -> 0x0118, all -> 0x016d }
        r8 = r2.zzQM();	 Catch:{ SQLiteException -> 0x0118, all -> 0x016d }
    ...
    int zzot() {
        ...
        if (currentTimeMillis <= this.zzbHa + 86400000) {
            return 0;
        }
        this.zzbHa = currentTimeMillis;
