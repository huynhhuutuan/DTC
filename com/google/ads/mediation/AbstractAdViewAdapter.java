...
public abstract class AbstractAdViewAdapter implements MediationBannerAdapter, MediationNativeAdapter, MediationRewardedVideoAdAdapter, zzrj {
    ...
    final RewardedVideoAdListener zzcJ = new C08891(this);

    class C08891 implements RewardedVideoAdListener {
        final /* synthetic */ AbstractAdViewAdapter zzcK;

        C08891(AbstractAdViewAdapter abstractAdViewAdapter) {
            this.zzcK = abstractAdViewAdapter;
        }

        public void onRewarded(RewardItem rewardItem) {
            this.zzcK.zzcI.onRewarded(this.zzcK, rewardItem);
        }

        public void onRewardedVideoAdClosed() {
            this.zzcK.zzcI.onAdClosed(this.zzcK);
            this.zzcK.zzcH = null;
        }

        public void onRewardedVideoAdFailedToLoad(int i) {
            this.zzcK.zzcI.onAdFailedToLoad(this.zzcK, i);
        }

        public void onRewardedVideoAdLeftApplication() {
            this.zzcK.zzcI.onAdLeftApplication(this.zzcK);
        }

        public void onRewardedVideoAdLoaded() {
            this.zzcK.zzcI.onAdLoaded(this.zzcK);
        }

        public void onRewardedVideoAdOpened() {
            this.zzcK.zzcI.onAdOpened(this.zzcK);
        }

        public void onRewardedVideoStarted() {
            this.zzcK.zzcI.onVideoStarted(this.zzcK);
        }
    }
    ...
    public void loadAd(MediationAdRequest mediationAdRequest, Bundle bundle, Bundle bundle2) {
        if (this.zzcG == null || this.zzcI == null) {
            zzqf.m9e("AdMobAdapter.loadAd called before initialize.");
            return;
        }
