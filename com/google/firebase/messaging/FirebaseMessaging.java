...
public class FirebaseMessaging {
    ...
    private static final Pattern zzclA = Pattern.compile("[a-zA-Z0-9-_.~%]{1,900}");
    private static FirebaseMessaging zzclB;
    private PendingIntent zzclC;
    ...
    public static synchronized FirebaseMessaging getInstance() {
        ...
        synchronized (FirebaseMessaging.class) {
            if (zzclB == null) {
                zzclB = new FirebaseMessaging(FirebaseInstanceId.getInstance());
            }
            firebaseMessaging = zzclB;
        }
    ...
    private synchronized void zzh(Context context, Intent intent) {
        if (this.zzclC == null) {
            ...
            this.zzclC = PendingIntent.getBroadcast(context, 0, intent2, 0);
        }
        intent.putExtra(SettingsJsonConstants.APP_KEY, this.zzclC);
    }
    ...
    public void subscribeToTopic(String str) {
        ...
        if (substring == null || !zzclA.matcher(substring).matches()) {
