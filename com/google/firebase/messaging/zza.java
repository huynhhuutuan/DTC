...
class zza {
    ...
    static synchronized zza zzcy(Context context) {
        ...
        synchronized (zza.class) {
            ...
            com_google_firebase_messaging_zza = zzcly;
        }
    ...
    private int zzeB(String str) {
        ...
        identifier = zzaca().getInt("com.google.firebase.messaging.default_notification_icon", 0);
        if (identifier == 0) {
    ...
    private Integer zzjD(String str) {
        ...
        if (VERSION.SDK_INT >= 21) {
            ...
            int i = zzaca().getInt("com.google.firebase.messaging.default_notification_color", 0);
            if (i != 0) {
                try {
